...
public class CommentRestController {
    ...
    public Response<CommentDto> createComment (@PathVariable Long postId, @ApiIgnore @AuthenticationPrincipal UserDetail userDetail, CommentCreateRequest request, String commentType) {
        // 로그인 정보 말고, 임시로 6번 유저 댓글로 설정
        CommentDto commentDto = commentService.create(postId, 6L, request, commentType);
...
//    public Response<Page<CommentDto>> readCommentPage (@PathVariable Long postId) {
//
//    }
}
